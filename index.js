...
const RealMadrid = require('./realmadrid.js')
const Barcelona = require('./barca.js')
const Arsenal = require('./arsenal.js')
const Liverpool = require('./liverpool.js')
const LaLiga = require('./laliga.js')
const PremierLeague = require('./premier.js')
